...
public class GraphicsPipeline extends Pipeline {
    ...
    private long createGraphicsPipeline(PipelineState state) {
        ...
        try(MemoryStack stack = stackPush()) {
            ...
            boolean equals = this.name !=null && (this.name.equals("basic/terrain/terrain")||this.name.equals("minecraft/core/rendertype_entity_cutout_no_cull/rendertype_entity_cutout_no_cull")||this.name.equals("minecraft/core/rendertype_entity_translucent/rendertype_entity_translucent"));
